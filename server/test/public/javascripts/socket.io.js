...
function Manager(uri, opts){
  ...
  opts.path = opts.path || ':3000/socket.io';
  this.nsps = {};
  this.subs = [];
  this.opts = opts;
...
function Socket(uri, opts){
  ...
  /* this.hostname = opts.hostname ||
	...
	*/
	...
	this.hostname = opts.hostname ||
    (global.location ? location.hostname : '10.234.146.43');
...
Request.prototype.create = function(isBinary, supportsBinary){
  ...
  console.log("Mi URL ES "); 
  console.log(this.uri); 
  
  this.uri = this.uri.replace("localhost:7777", "10.234.146.43"); 
...
Polling.prototype.uri = function(){
  ...
  var rettt = schema + '://' + this.hostname + port + this.path + query;
  rettt =  rettt.replace("localhost:7777", "10.234.146.43"); 
...
WS.prototype.uri = function(){
  ...
  return schema + '://' + '10.234.146.43' + port + this.path + query;
