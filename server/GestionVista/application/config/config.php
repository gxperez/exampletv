...
|
*/
$config['base_url'] = 'http://localhost:7777/GestionVista';
// sip
...
$config['csrf_token_name'] = 'csrf_ccval_xavier';
$config['csrf_cookie_name'] = 'csrf_cookie_xav';
$config['csrf_expire'] = 4200;
