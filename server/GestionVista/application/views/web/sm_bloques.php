<div  ng-controller="BloquesController" ng-init= "initt(); vCrud.setHash('<?=$csrf["name"];?>', '<?=$csrf["hash"];?>' );">
    ...
    <div id="header-crudTools" class="crudTools col-md-12">     
     ...
     <div class="col-md-12">
                          ...
                          <div class="panel-body">
                              <div class="task-content">
                                  <ul id="sortable" class="task-list">
                                      <li ng-repeat="item in listaBloques|filter:buscarLista:strict" class="list-primary">
                                          <i class=" fa fa-ellipsis-v"></i>
                                          <div class="task-checkbox">
                                              <input type="checkbox" class="list-child" value=""  />
                                          </div>
                                          <div class="task-title">
                                              <span class="task-title-sp">{{item.HoraInicio}} - {{item.HoraFin}} </ span>
           ...
           <div id="formulario" >        
			...
			<label class="col-sm-2 col-sm-2 control-label">ProgramacionID</label>
			<div class="col-sm-10">
            	<input type="int" ng-model="vCrud.form.ProgramacionID" class="form-control" required>
           </div>
</div>
<div class="form-group">
			<label class="col-sm-2 col-sm-2 control-label">FrecuenciaTipo</label>
			<div class="col-sm-10">
            	<?php  Text::renderOptions('<select ng-model="vCrud.form.FrecuenciaTipo" class="form-control" required>', $listFrecuenciaTipo); ?>
           </div>
</div>
<div class="form-group">
			<label class="col-sm-2 col-sm-2 control-label">FrecuenciaNumero</label>
			<div class="col-sm-10">
            	<input type="text" ng-model="vCrud.form.FrecuenciaNumero" class="form-control" required>
           </div>
</div>
<div class="form-group">
...
<div class="form-group">
			...
			<div class="col-sm-10">
            	<input type="text" ng-model="vCrud.form.HoraInicio" class="form-control" required>
           </div>
</div>
<div class="form-group">
			<label class="col-sm-2 col-sm-2 control-label">HoraFin</label>
			<div class="col-sm-10">
            	<input type="text" ng-model="vCrud.form.HoraFin" class="form-control" required>
           </div>
</div>
<div class="form-group">
...
<div class="form-group">
			...
			<div class="col-sm-10">
            	<input type="text" ng-model="vCrud.form.FechaModificacion" class="form-control" >
           </div>
</div>
