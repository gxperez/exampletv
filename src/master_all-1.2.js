...
ConfigSetting = {
	...
	serverApp: '10.234.51.99:8079/GestionVista/'
}; 
...
var mTimer = {
	...
	setTimerToChange: function(sec){
		...
		$("#timerToChange").html("<span class='fa fa-clock-o'></span> <span class='clockT'> " + strTimeOut + " </span>"); 
...
// Golf-Shirt-Grey.jpg
	 ...
	 setInicioPage: function(callback){
	 	...
	 	//	$("#mybody").html("<h2 style='color: white;'>Que ha Pasado</h2>");
	 		if(typeof callback === "function") {
	 			callback(); 
	 		}
	 	}); 
